...
;	CMakeCCompilerId.c:321: char const* info_compiler = "INFO" ":" "compiler[" COMPILER_ID "]";
	mov	_info_compiler,#___str_0
	mov	(_info_compiler + 1),#(___str_0 >> 8)
	mov	(_info_compiler + 2),#0x80
;	CMakeCCompilerId.c:614: char const* info_platform = "INFO" ":" "platform[" PLATFORM_ID "]";
	mov	_info_platform,#___str_1
	mov	(_info_platform + 1),#(___str_1 >> 8)
	mov	(_info_platform + 2),#0x80
;	CMakeCCompilerId.c:615: char const* info_arch = "INFO" ":" "arch[" ARCHITECTURE_ID "]";
	mov	_info_arch,#___str_2
	mov	(_info_arch + 1),#(___str_2 >> 8)
	mov	(_info_arch + 2),#0x80
;	CMakeCCompilerId.c:634: const char* info_language_dialect_default =
...
;require                   Allocated to registers r2 r5 
;------------------------------------------------------------
;	CMakeCCompilerId.c:645: int main(int argc, char* argv[])
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	...
	mov	r6,dpl
	mov	r7,dph
;	CMakeCCompilerId.c:649: require += info_compiler[argc];
	mov	a,r6
	...
	mov	r3,a
	mov	r5,#0x00
;	CMakeCCompilerId.c:650: require += info_platform[argc];
	mov	a,r6
	...
	addc	a,r5
	mov	r4,a
;	CMakeCCompilerId.c:651: require += info_arch[argc];
	mov	a,r6
	add	a,_info_arch
	mov	r2,a
	mov	a,r7
	...
	addc	a,r4
	mov	r5,a
;	CMakeCCompilerId.c:653: require += info_version[argc];
	mov	a,r6
	add	a,#_info_version
	mov	dpl,a
	mov	a,r7
	...
	addc	a,r5
	mov	r5,a
;	CMakeCCompilerId.c:667: require += info_language_dialect_default[argc];
	mov	a,r6
	...
	addc	a,r5
	mov	dph,a
;	CMakeCCompilerId.c:669: return require;
;	CMakeCCompilerId.c:670: }
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
_info_version:
